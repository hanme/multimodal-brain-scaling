...
> **all 7 models**: whisper (tiny, base, small, medium, large) + **wav2vec2 (medium, large)**;
> denominators **/48** per model and **/336** pooled; source
...
> should be reconciled separately — in particular **Section 9's deviance-scaling is still 20 methods ×
> 4 models (n = 80)** and does not yet include whisper-large or either wav2vec2 model.
>
