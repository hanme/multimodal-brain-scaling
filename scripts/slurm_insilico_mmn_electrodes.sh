...
source env.sh
mkdir -p logs outputs_new_pre_tone_baseline/figures/insilico_mmn_electrodes outputs_new_pre_tone_baseline/insilico_mmn_predictions
...
OMP_NUM_THREADS=${SLURM_CPUS_PER_TASK:-4} python scripts/insilico_mmn_electrodes.py \
    ...
    --out_dir "outputs_new_pre_tone_baseline/figures/insilico_mmn_electrodes/${MODEL_ID}" \
